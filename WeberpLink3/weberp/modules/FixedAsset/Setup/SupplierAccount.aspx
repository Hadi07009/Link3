<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SupplierAccount.aspx.cs"  MasterPageFile="~/masMain.master"  Inherits="modules_FixedAsset_Setup_SupplierAccount" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" >
    ...
    <ContentTemplate>
        ...
        <asp:Label ID="lblleave" Text="SUPPLIER ACCOUNT ENTRY" runat="server" />
    </asp:Panel>
    ...
    <div style="width: 1182px">
        ...
        <table class="style1" width="100%" style="text-align:left">
            <tr>
                <td colspan="10" style="height: 42px">
            ...
            <tr>
                ...
                <td class="style4">
                    ...
                    <cc2:AutoCompleteExtender ID="txtSearch_AutoCompleteExtender" runat="server" DelimiterCharacters="" Enabled="True" MinimumPrefixLength="1" ServiceMethod="GetSupplierAccountInformation" ServicePath="~/modules/FixedAsset/services/InvAutoComplete.asmx" TargetControlID="txtSearch">
                ...
                <td >
                    <asp:TextBox ID="txtcode" runat="server" Width="400px" AutoPostBack="True" 
                      ...
                      <cc1:AutoCompleteExtender ID="autoComplete1" runat="server" 
                            ...
                            ServiceMethod="GetSupplierAccountInformation" 
            ...
            <tr>
                ...
                <td class="style8">
                    :</td>
                <td class="style2">
                    <asp:TextBox ID="txtcheckClearingAccount" runat="server" AutoPostBack="True" ontextchanged="txtcheckClearingAccount_TextChanged" Width="400px"></asp:TextBox>
                    <cc2:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" CompletionListItemCssClass="autocomplete_listItem" CompletionSetCount="12" MinimumPrefixLength="2" ServiceMethod="GetCoaAccountCode" ServicePath="~/modules/FixedAsset/services/InvAutoComplete.asmx" TargetControlID="txtcheckClearingAccount">
                    </cc2:AutoCompleteExtender>
                </td>
                <td>
                    &nbsp;</td>
            ...
            <tr>
                ...
                <td class="style3" >
                    <asp:Label ID="Label21" runat="server" Font-Bold="True" Font-Size="10pt" Text="Analysis Required" Width="137px"></asp:Label>
                </td>
                <td class="style8">
                    :</td>
                <td class="style2">
                    <asp:CheckBox ID="chkanalysis" runat="server" AutoPostBack="True" oncheckedchanged="chkanalysis_CheckedChanged" Text="YES" Visible="False" />
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            ...
            <tr>
                <td class="style5" colspan="3" rowspan="6">
                    <asp:Panel ID="pnlAccountGroup" runat="server" Height="100%">
                        <table style="width: 97%">
                            ...
                            <tr>
                                ...
                                <td style="width: 8px">
                                    :</td>
                                <td>
                                    <asp:TextBox ID="txtfirstgroup" runat="server" Width="400px">AP:Accounts Payable</asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="width: 8px">
                                    :</td>
                                <td>
                                    <asp:TextBox ID="txtsecondgroup" runat="server" Width="400px">LIABGDSSUPL:Liabilities for goods Supply</asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="width: 8px">
                                    :</td>
                                <td>
                                    <asp:TextBox ID="txtthirdgroup" runat="server" Width="400px">LIABGDSSPL:Liabilities for goods Supply</asp:TextBox>
                ...
                <td class="style3" colspan="3" rowspan="6">
                    <asp:Panel ID="pnlAnalysis" runat="server" Height="119px" Visible="False">
