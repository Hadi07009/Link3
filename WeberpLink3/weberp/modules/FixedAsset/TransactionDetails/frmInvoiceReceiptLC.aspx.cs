...
public partial class frmInvoiceReceiptLC : System.Web.UI.Page
{
    ...
    {
        var dtInsuTrnSet = DataProcess.GetData(_connectionString, SqlgenerateForFixedAsset.GetSupplierByPendingInvoice("FPO"));
    ...
    protected void gvMrrData_SelectedIndexChanged(object sender, EventArgs e)
    {
         ...
         if (indx != -1)
         {
             ...
             GetAccessPermission(userid, "frmInvoiceReceiptLC");
         }
    }
     ...
     private void GetAccessPermission(string userid,string formname)
     {
         try
         {
             ...
             foreach (DataRow dr in dt.Rows)
             {
                 ...
                 if (dr["controllname"].ToString() == "btnSaveFinal" && dr["AccessPermission"].ToString() == "N")
                 {
     ...
     protected void btnSaveFinal_Click(object sender, EventArgs e)
     {
        ...
        {                  
            ...
            {               
                ...
                DateTime entrydate = System.DateTime.Now;
                if (ii == 0)
                    DataProcess.ExecuteQuery(_connectionString, SqlgenerateForFixedAsset.DeleteLcExpense(pono, lcno));
