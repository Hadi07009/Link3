...
public partial class modules_FixedAsset_TransactionDetails_ServicelogAsset : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            LoadTrnType(4);
            LoadItemRevalueationInformation(4);
    ...
    protected void ddlTrackingNo_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (trackingNo != "-1" && dtItemInformaton.Rows.Count > 0)
        {
    ...
    private void LoadItemRevalueationInformation(int TypeId)
    {
        string _msg = null;
        try
        {
            var storedProcedureCommandTest = "exec [FAGetAllFrom_FA_Item_RevalueationServicelog] " + TypeId + "";
    ...
    private string SaveItemRevalueationInformation()
    {
        ...
        objItemRevalueation.Description = txtDescription.Text;
        objItemRevalueation.TxtTag = btnSave.Text;
        if (objItemRevalueation.TxtTag == "Save")
        {
            return Save(_connectionString, objItemRevalueation);
        }
        else
        {
            return Update(_connectionString, objItemRevalueation);
        }
    ...
    public string Save(string connectionString, ItemRevalueation objItemRevalueation)
    {
        ...
        try
        {
            var storedProcedureComandTest = "exec [FAInitiateInto_FA_Item_RevalueationSercicelog] " + 0 + "," +
                                ...
                                "'" + objItemRevalueation.Description + "'";
    ...
    public string Update(string connectionString, ItemRevalueation objItemRevalueation)
    {
        ...
        try
        {
            var storedProcedureComandTest = "exec [FAInitiateInto_FA_Item_RevalueationSercicelog] " + Convert.ToInt32(lblRefNumber.Text) + "," +
                                 "'" + objItemRevalueation.TrnDate + "'," +
                                 "'" + objItemRevalueation.ItemCode + "'," +
                                 "'" + objItemRevalueation.TrackingNo + "'," +
                                 "" + objItemRevalueation.LineNumber + "," +
    ...
    protected void grdItemRevalueation_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.Equals("Select"))
        {
            ...
            string lblDescription = ((Label)grdItemRevalueation.Rows[selectedIndex].FindControl("lblDescription")).Text;
            ...
            txtDescription.Text = lblDescription;
