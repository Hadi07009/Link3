<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmInvoiceReceiptLC.aspx.cs" Inherits="frmInvoiceReceiptLC"  EnableEventValidation="false" ValidateRequest="false" %>
                ...
                <tr>
                    <td class="auto-style19" colspan="4">
                        <asp:GridView ID="gridMrr" runat="server" BackColor="White" BorderColor="#32A545" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" Font-Names="Arial" Font-Size="10pt" ForeColor="#333333" HeaderStyle-HorizontalAlign="Left"  Width="100%" OnRowDataBound="gridMrr_RowDataBound"  ShowFooter="true">
                                  ...
                                  <tr>
                                      <td class="auto-style21">
                                          <asp:Label ID="Label28" runat="server" Text="LC Number"></asp:Label>
                                      </td>
                                      <td>:</td>
                                      <td>
                                  ...
                                  <tr>
                                      <td class="auto-style21">
                                          <asp:Label ID="Label25" runat="server" Text="LC Expense "></asp:Label>
                                      </td>
                                      <td>:</td>
                                      <td>
                                          <table style="width:100%;">
                                              <tr>
                                                  ...
                                                  <td>
                                                      <asp:Label ID="Label29" runat="server" Text="Liability Head"></asp:Label>
                                                  </td>
                                                  <td>&nbsp;</td>
                                              </tr>
                                              <tr>
                                  ...
                                  <tr>
                                      ...
                                      <td align="left" class="auto-style25">
                                          ...
                                          &nbsp;&nbsp;<asp:Button ID="btnVatTaxUpdate" runat="server" OnClick="btnVatTaxUpdate_Click" Text="Recommend Modification" Width="120px" />
&nbsp;
