<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="ServicelogAsset.aspx.cs" Inherits="modules_FixedAsset_TransactionDetails_ServicelogAsset" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="PanelLeaveHdr" runat="server" CssClass="cpHeaderContent" Width="100%">
        <asp:Label ID="lblleave" Text="Service log Asset" runat="server" />
    </asp:Panel>
    ...
    <table style="width:100%; text-align:left">
        ...
        <tr>
            ...
            <td style="width: 14px">:</td>
            <td style="width: 410px">
                <asp:TextBox ID="txtDescription" runat="server" Height="75px" TextMode="MultiLine" Width="400px"></asp:TextBox>
            </td>
            <td style="text-align:left">&nbsp;</td>
        </tr>
        <tr>
                ...
                <asp:GridView ID="grdItemRevalueation" runat="server" Width="100%" AutoGenerateColumns="False" OnRowCommand="grdItemRevalueation_RowCommand" OnRowDataBound="grdItemRevalueation_RowDataBound">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Description">
                            <ItemTemplate>
                                <asp:Label ID="lblDescription" runat="server" Text='<%# Bind("ServiceDescription") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
