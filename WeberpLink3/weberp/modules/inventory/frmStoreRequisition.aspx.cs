...
public partial class frmStoreRequisition : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        //if (Session[StaticData.sessionUserId].ToString() == "L3T035" || Session[StaticData.sessionUserId].ToString() == "L3T143")
        //{
        //    if (txtStore.Text != "CGEN:Chittagong Store")
        //    {
        //        lblerrormsg.Visible = true;
        //        lblerrormsg.Text = "You have no Permission for this Store";
        //        return;
        //    }
        //}

        //if (Session[StaticData.sessionUserId].ToString() == "L3T072" || Session[StaticData.sessionUserId].ToString() == "L3T588")
        //{
        //    if (txtStore.Text != "SGEN:Sylhet Store")
        //    {
        //        lblerrormsg.Visible = true;
        //        lblerrormsg.Text = "You have no Permission for this Store";
        //        return;
