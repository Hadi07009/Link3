<%@ Page Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frm_mat_rec_confirm_final.aspx.cs" Inherits="frm_mat_rec_confirm_final" Title=""   EnableEventValidation="false" %>
...
<table id="tblmaster" runat="server" class="tblmas" style="width: 100%">
        ...
        <tr>
            <td class="tbl" colspan="3" style="height: 24px; text-align: left">
                MODE OF DELIVERY:
                <asp:Label ID="lblmodeofdel" runat="server" Font-Bold="True" Text="Label"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="tbl" colspan="3" style="height: 24px; text-align: center">
