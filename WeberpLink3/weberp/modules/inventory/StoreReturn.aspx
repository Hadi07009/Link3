<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/masMain.master"  CodeFile="StoreReturn.aspx.cs" Inherits="modules_inventory_StoreReturn" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    
    <div align="center">
        <asp:Panel ID="pnlSrchMrrHdr" runat="server" CssClass="cpHeaderContent" Width="100%">
            <div align="center">
                <asp:Label ID="lblSearchMrr" Text="STORE RETURN MEMO " runat="server" />
            </div>

        </asp:Panel>
        <asp:Panel ID="pnlSrchMrrDet" runat="server" CssClass="cpBodyContent" Width="99%" Height="120px">
            <table>
                <tr>
                    <td >&nbsp;</td>
    ...
    <asp:Panel ID="pnlClientInformation" runat="server" CssClass="cpHeaderContent" Width="99%">
        <div align="center"">
            <asp:Label ID="ImageButton5" runat="server" Text="RETURN ITEM" />
        </div>
    </asp:Panel>
    <asp:Panel ID="pnl" runat="server" CssClass="cpBodyContent" Height="500px"  Width="99%">
        <table width="100%">
            <tr>
