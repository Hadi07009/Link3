<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true"  CodeFile="frmMRR.aspx.cs" Inherits="frmMRR" %>
             ...
             <table style="width:100%;">
                 <tr>
                     <td>
                         &nbsp;</td>
                     <td align="center">
                         <asp:Panel ID="pnltitle" runat="server" CssClass="cpHeaderContent" width="99%">
                         Material Receive (MRR)
                             </asp:Panel>
                     </td>
                     <td>
                         &nbsp;</td>
                 ...
                 <tr>
                     ...
                     <td>
                         ...
                         <asp:Panel ID="pnlSrchMrrHdr" runat="server" CssClass="cpHeaderContent" Width="99%" Visible="False" >
                            <asp:Label ID="lblSearchMrr" Text="Search MRR" runat="server" />
                         </asp:Panel>
                         <asp:Panel ID="pnlSrchMrrDet" runat="server" CssClass="cpBodyContent" Width="99%"  
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <%-- </div>--%>
                         <br />
                         <%--<div align="center">--%>
                         <asp:Panel ID="pnlSelectPoHdr" runat="server" CssClass="cpHeaderContent" Width="99%">
                            <asp:Label ID="lblSelectPO" Text="Select PO" runat="server" />
                         </asp:Panel>
                         <asp:Panel ID="pnlSelectPoBody" runat="server" CssClass="cpBodyContent" Width="99%" 
                                 Height="275px">
                                 ...
                                 <td>
                                     &nbsp;</td>
                                 <td>
                                 <asp:TextBox ID="txtSelectPO" runat="server" Width="300px" Visible="False"></asp:TextBox>
                                 ...
                                 <td>
                                     <asp:Button ID="btnSelectPo" runat="server" Text="Select" onclick="btnSelectPo_Click" Visible="False" />
                                 </td>
                                     <td>
                                         &nbsp;</td>
                                 </tr>
                                     ...
                                     <tr>
                                         <td>Select PO:</td>
                                         <td>
                                             <asp:DropDownList ID="ddlpolist" runat="server" AutoPostBack="True" Width="500px">
                                             </asp:DropDownList>
                                             <cc1:ListSearchExtender ID="ListSearchExtender2" runat="server" PromptCssClass="ListSearchExtenderPrompt" QueryPattern="Contains" QueryTimeout="2000" TargetControlID="ddlpolist">
                                             </cc1:ListSearchExtender>
                                             &nbsp;
                                             <asp:Button ID="btnShowPO" runat="server" onclick="btnShowPO_Click" Text="View" Width="100px" />
                                         </td>
                                         <td>&nbsp;</td>
                                         <td>
                                             <asp:Button ID="btnClearPo" runat="server" onclick="btnClearPo_Click" Text="Clear" Visible="False" Width="60px" />
                                         </td>
                                     </tr>
                                 ...
                                 <div id="Div2" style="width: 100%; height: 232px; overflow:auto;" runat="server">                                                                  
                                             <asp:GridView ID="gvPoDet" runat="server" AutoGenerateColumns="False" 
                                                 ...
                                                 onselectedindexchanged="gvPoDet_SelectedIndexChanged" RowStyle-VerticalAlign="Middle"
                                                 onrowcommand="gvPoDet_RowCommand" onrowdatabound="gvPoDet_RowDataBound" Width="100%">
                                                 <Columns>
                                                     ...
                                                     <asp:BoundField DataField="PO_Det_Bal_Qty" HeaderText="Balance Qty." >                                                     
                                                         <HeaderStyle HorizontalAlign="Left" />
                                                     </asp:BoundField>
                                                     ...
                                                     <asp:TemplateField HeaderText="MRR Qty.">
                                                         ...
                                                         <ItemTemplate>                                                             
                                                             <asp:TextBox ID="txtMrrQty" Width="80px" runat="server" Text='<%# Bind("Po_Det_Mrr_Qty") %>'></asp:TextBox>
                                                             <asp:CompareValidator ID="CompareValidator1" runat="server"
                                                                ControlToValidate="txtMrrQty"
                                                                ErrorMessage="The MRR quantity must be equal or less than PO quantity." 
                ...
                <tr>
                    ...
                    <td>
                       ...
                       <%--  <div align="center" style="width:100%">--%>
                         ...
                         <asp:Panel ID="pDetBody" runat="server" CssClass="cpBodyContent" Width="99%" Height="500px">
                                   
                                 <div style="width: 100%; overflow:auto;" runat="server">
                                 ...
                                 <br />
                              <span>
                              <asp:Button ID="btnHold" runat="server" onclick="btnHold_Click" Text="Hold" Visible="False" />
                                 &nbsp;&nbsp;&nbsp;
