<%@ Page Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frm_mrr_print_report.aspx.cs" Inherits="frm_mrr_print_report" Title=""   %>
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td style="width: 151px; text-align: left;">
                            <asp:DropDownList ID="ddlstore" Width="387px" CssClass="txtbox" 
                                runat="server" />
                            </td>
                        <td style="width: 36px">
                                        &nbsp;</td>
        ...
        <tr>
            ...
            <div style="text-align: center">
                <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" 
                    ...
                    PrintMode="ActiveX" onunload="CrystalReportViewer1_Unload" />
            </div>
            </td>
        </tr>
        <tr>
