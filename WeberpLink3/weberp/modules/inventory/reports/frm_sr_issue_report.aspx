<%@ Page Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frm_sr_issue_report.aspx.cs" Inherits="frm_sr_issue_report"  EnableEventValidation="false" %>
...
<table id="tblmaster" runat="server" class="tblmas" style="width: 100%">
        ...
        <tr>
            <td class="heading" colspan="3" style="text-align: center">
                STORE REQUISITION AND ISSUE NOTE</td>
        </tr>
        <tr>
                ...
                <table id="tblcostcenter" runat="server">
                    ...
                    <tr>
                        ...
                        <td style="width: 412px; text-align: left">
                            ...
                            <asp:TextBox ID="txtsrref" runat="server" Width="400px"></asp:TextBox>

                            <ajaxToolkit:AutoCompleteExtender
                                runat="server"                                
                                ID="Autoteforsrref" 
                                BehaviorID="Autsr"                                
                                TargetControlID="txtsrref"
                                ServicePath="~/modules/commercial/services/autocomplete.asmx"
                                ServiceMethod="GetAllSrref"
