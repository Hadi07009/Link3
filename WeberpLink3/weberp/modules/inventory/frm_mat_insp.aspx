<%@ Page Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frm_mat_insp.aspx.cs" Inherits="frm_mat_insp" Title=""   EnableEventValidation="false" %>
            ...
            <td class="tbl" colspan="3" style="height: 22px; text-align: left">
                        ...
                        <asp:GridView ID="gdItem" runat="server" AutoGenerateColumns="False" 
                            ...
                            <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Rec For Ins">
                                    <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Serial Number">
                            <ItemTemplate>
                                <asp:TextBox ID="TextBox4" runat="server" CssClass="txtbox" Width="150px" TextMode="MultiLine" />
                            </ItemTemplate>
                        </asp:TemplateField>
