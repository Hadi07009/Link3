<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmOffdayApplication.aspx.cs" Inherits="ClientSide_modules_mis_naz_FORMS_HRMS_Forms_frmOffdayApplication" %>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <table style="width: 100%;">
                                                <tr>
                                                    <td class="style9">
                                                        <asp:Label ID="Label12" runat="server" Text="Employee Information"></asp:Label>
                                                    </td>
                                                    <td class="style20">&nbsp;</td>
                                                    <td class="style23">&nbsp;</td>
                                                    <td style="text-align: center">
                                                        <asp:Label ID="Label15" runat="server" Text="Previous off day Information"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="style9">
                                            ...
                                            <asp:GridView ID="grdHoliday" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Extra Hour">
                                                        <FooterTemplate>
                                                            <asp:Label ID="lblExtraHours" runat="server" Text="Label"></asp:Label>
                                                        </FooterTemplate>
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblItemExH" runat="server" Text='<%#Eval("totalHours").ToString()%>'>
                                                            </asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <%--<asp:BoundField DataField="totalHours"  HeaderText="Extra Hours"/> --%>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <table style="width: 100%;">
                                                ...
                                                <tr>
                                                    <td>&nbsp;<asp:Label ID="Label18" runat="server" Text="Reason/ Remarks"></asp:Label>
                                                    </td>
                                                    <td>:</td>
