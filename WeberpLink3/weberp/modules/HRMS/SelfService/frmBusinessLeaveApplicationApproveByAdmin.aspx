<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmBusinessLeaveApplicationApproveByAdmin.aspx.cs" Inherits="Modules_HRMS_SelfService_frmBusinessLeaveApplicationApproveByAdmin" %>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:Button ID="btnApply" runat="server" OnClick="btnApply_Click"
                                            Text="Apply &amp; Approve" Width="150px" />
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                            </table>
