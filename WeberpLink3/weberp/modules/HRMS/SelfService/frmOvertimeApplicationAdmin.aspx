<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmOvertimeApplicationAdmin.aspx.cs" Inherits="ClientSide_modules_mis_naz_FORMS_HRMS_Forms_frmOvertimeApplicationAdmin" %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: right">
                                                        <table style="width: 100%;">
                                                            <tr>
                                                                <td class="style21">
                                                                    <asp:Label ID="Label17" runat="server" Text="Employee ID" Width="90px"></asp:Label>
                                                                </td>
                                                                <td class="style22">:</td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td class="style21">
                                                                    <asp:Label ID="Label18" runat="server" Text="From" Width="90px"></asp:Label>
                                                                </td>
                                                                <td class="style22">:</td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td class="style21">
                                                                    <asp:Label ID="Label19" runat="server" Text="To" Width="90px"></asp:Label>
                                                                </td>
                                                                <td class="style22">:</td>
                                                                <td>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <table style="width: 100%;">
                                                ...
                                                <tr>
                                                    <td>&nbsp;<asp:Label ID="Label20" runat="server" Text="Reason/ Remarks"></asp:Label>
                                                    </td>
                                                    <td>:</td>
