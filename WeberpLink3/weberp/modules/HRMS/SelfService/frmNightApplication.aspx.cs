...
public partial class ClientSide_modules_mis_naz_FORMS_HRMS_Forms_frmNightApplication : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            LoadNightDetailsemployeeID(Session["ApplicantID"].ToString(),PID,FID, fDate, lDate);           
    ...
    private void LoadNightDetailsemployeeID(string empid, string Processid, string flowid, DateTime fDate, DateTime lDate)
    {
        DataTable dt = new DataTable();
        SqlCommand cmd = new SqlCommand();
        SqlConnection sqlConn = null;
        ...
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandText = "spProcessGetNightStatus";
    ...
    protected void btnApply_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this, GetType(), "MessageBox", "alert(' Night amount is not configured yet.Please contact human resource department');", true);
            return;
        }
        ...
        try
        {
            ...
            string retval = lvproc.SaveInitiateNightProcessData(lvphdrlst, myCommand);
            if (retval.ToString() == "")
            {
                myTrans.Rollback("SaveAllTransaction");
            }
    ...
    protected void grdHoliday_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            int totalMin = Convert.ToInt32(e.Row.Cells[21].Text.ToString());//just changed the index of cells based on your requirements 
        ...
        {
            e.Row.Cells[12].Text = "Total Extra Hour";
            e.Row.Cells[20].Text = DateProcess.TimeDuration(Convert.ToInt32(total.ToString()));
      ...
      //  e.Row.Cells[3].Visible = false;
       ...
       // e.Row.Cells[20].Visible = false;  //Extra Hour
        e.Row.Cells[21].Visible = false;    // Extra Minutes
    }
}
