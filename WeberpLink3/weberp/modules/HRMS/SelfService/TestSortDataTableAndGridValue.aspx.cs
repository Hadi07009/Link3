...
public partial class modules_HRMS_SelfService_TestSortDataTableAndGridValue : System.Web.UI.Page
{
    ...
    protected void btnStringFormat_Click(object sender, EventArgs e)
    {
        StringGenerator objStringGenerator = new StringGenerator();
        lblStringFormat.Text = string.Empty;
        lblStringFormat.Text = objStringGenerator.CommaSeparatedlistFromGridView(grdEmployeeRecord,"1,0,2");
    }
}