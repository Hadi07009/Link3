<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmProcessDetails.aspx.cs" EnableEventValidation="false" Inherits="modules_HRMS_SelfService_frmProcessDetails" %>
    ...
    <asp:UpdatePanel ID="updpnl2" runat="server">        
        <ContentTemplate>
            <asp:Panel ID="PanelLeaveHdr" runat="server" CssClass="cpHeaderContent" Width="100%">
                <asp:Label ID="lblleave" Text="Process Details" runat="server" />
            </asp:Panel>
                            ...
                            <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="4"
                                        ...
                                        <table style="width: 100%; text-align: left">
                                            <tr>
                                                <td style="width: 138px">
                                                    <asp:Label ID="Label21" runat="server" Text="Process Description"></asp:Label>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:TextBox ID="txtProcessId" runat="server" Visible="False"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 138px">&nbsp;</td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 7px">&nbsp;</td>
                                                <td>
                                                    <asp:GridView ID="grdViewProcessDescription" runat="server"
                                                        AutoGenerateColumns="False"
                                                        OnRowCommand="grdViewProcessDescription_RowCommand"
                                                        OnRowEditing="grdViewProcessDescription_RowEditing"
                                                        OnRowDataBound="grdViewProcessDescription_RowDataBound" Width="100%">
                                                        <Columns>
                                                            <asp:BoundField DataField="ProcessId" HeaderText="Process Id" />
                                                            <asp:BoundField DataField="ProcessDescription"
                                        ...
                                        <table style="width: 100%; text-align: left">
                                            <tr>
                                                <td style="width: 122px">
                                                    <asp:Label ID="Label18" runat="server" Text="Process ID"></asp:Label>
                                                </td>
                                                <td>:</td>
                                                <td>
                                                    <asp:DropDownList ID="ddlProcessId" runat="server" AutoPostBack="True" Style="margin-left: 0px" Width="305px">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="txtProcessFlowDescription" runat="server" Style="margin-top: 5px" Width="300px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>&nbsp;</td>
                                                <td>
                                                    <asp:Button ID="btnSaveProcessFlowDescription" runat="server" OnClick="btnSaveProcessFlowDescription_Click" Style="height: 26px" Text="Save" Width="100px" />
                                                    <asp:TextBox ID="txtProcessFlowId" runat="server" Visible="False"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 122px">&nbsp;</td>
                                ...
                                <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="TabPanel3">
                                    ...
                                    <ContentTemplate>
                                        <table style="width: 100%; text-align: left">
                                            <tr>
                                                <td style="width: 122px">
                                                    <asp:Label ID="Label16" runat="server" Text="Process ID"></asp:Label>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Button ID="btnSaveLevelDescription" runat="server"
                                                        OnClick="btnSaveLevelDescription_Click" Text="Save" Width="100px" />
                                                    <asp:TextBox ID="txtProcessLevelId" runat="server" Visible="False"></asp:TextBox>
                                                </td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                ...
                                <cc1:TabPanel ID="TabPanel4" runat="server" HeaderText="TabPanel4">
                                    ...
                                    <ContentTemplate>
                                        <table style="width: 100%; text-align: left">
                                            <tr>
                                                <td style="width: 94px">
                                                    <asp:Label ID="Label14" runat="server" Text="Process ID"></asp:Label>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Button ID="btnSaveProcessActionType" runat="server"
                                                        OnClick="btnSaveProcessActionType_Click" Text="Save" Width="100px" />
                                                    <asp:TextBox ID="txtActionTypeId" runat="server" Visible="False"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 94px">&nbsp;</td>
                                ...
                                <cc1:TabPanel ID="TabPanel5" runat="server" HeaderText="TabPanel5">
                                    ...
                                    <ContentTemplate>
                                        <table style="width: 100%; text-align: left">
                                            <tr>
                                                <td>&nbsp;<asp:Label ID="Label1" runat="server" Text="Process ID"></asp:Label>
                                                </td>
                                                <td>:</td>
                                                <td colspan="4">
                                            ...
                                            <tr>
                                                <td>&nbsp;<asp:Label ID="Label2" runat="server" Text="Process Flow ID"></asp:Label>
                                                </td>
                                                <td>:</td>
                                                <td colspan="4">
                                            ...
                                            <tr>
                                                <td>&nbsp;<asp:Label ID="Label3" runat="server" Text="Department ID"></asp:Label>
                                                </td>
                                                <td>:</td>
                                                <td colspan="4">
                                            ...
                                            <tr>
                                                <td colspan="13">
                                                    <asp:Panel ID="PanelLeaveHdr2" runat="server" CssClass="cpHeaderContent" HorizontalAlign="Center" Width="100%">
                                                        APPROVAL FLOW CONFIGURE</asp:Panel>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="135px">&nbsp;<asp:Label ID="Label5" runat="server" Text="Level"></asp:Label>
                                                </td>
                                                <td>&nbsp;</td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:Label ID="Label23" runat="server" Text="Access Permission"></asp:Label>
                                                </td>
                                                <td>&nbsp;</td>
                                                <td>
                                                    &nbsp;</td>
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <asp:DropDownList ID="ddlProcessLevelId" runat="server" Width="100px">
                                                    </asp:DropDownList>
                                                </td>
                                                <td rowspan="2">&nbsp;</td>
                                                <td valign="top">
                                                    <asp:TextBox ID="txtAccessId" runat="server" AutoPostBack="True"
                                                        OnTextChanged="txtAccessId_TextChanged" Style="height: 22px" Width="170px"></asp:TextBox>
                                                ...
                                                <td valign="top" rowspan="2">
                                                    <div style="overflow: scroll; height: 65px;  border-width: 1px; border-style: solid; border-color: black;">
                                                        <asp:CheckBoxList ID="ChkLisBoxAccessPermissionType" runat="server" RepeatDirection="Horizontal">
                                                        </asp:CheckBoxList>
                                                    </div>
                                                </td>
                                                <td rowspan="2">&nbsp;</td>
                                                <td valign="top">
                                                    <asp:TextBox ID="txtSubAccessId0" runat="server" AutoPostBack="True"
                                                        OnTextChanged="txtSubAccessId0_TextChanged" Style="margin-left: 0px" Width="170px"></asp:TextBox>
                                                    <cc1:AutoCompleteExtender ID="txtSubAccessId0_AutoCompleteExtender"
                                                ...
                                                <td rowspan="2">&nbsp;</td>
                                                <td valign="top">
                                                    <asp:Button ID="btnAdd" runat="server" CssClass="btn2" OnClick="btnAdd_Click" Text="Add" Width="70px" />
                                                </td>
                                                <td>&nbsp;</td>
                                                <td valign="top">
                                                    <asp:TextBox ID="txtMonitoringId1" runat="server" AutoPostBack="True" OnTextChanged="txtMonitoringId1_TextChanged" Style="height: 22px" Visible="False" Width="155px"></asp:TextBox>
                                                    <cc1:AutoCompleteExtender ID="txtMonitoringId1_AutoCompleteExtender" runat="server" DelimiterCharacters="" Enabled="True" MinimumPrefixLength="1" ServiceMethod="Emp_Mas_Emp_Id" ServicePath="~/modules/Payroll/WebService.asmx" TargetControlID="txtMonitoringId1">
                                                    </cc1:AutoCompleteExtender>
                                                    <asp:TextBox ID="txtSuperUserId1" runat="server" AutoPostBack="True" OnTextChanged="txtSuperUserId1_TextChanged" Visible="False" Width="155px"></asp:TextBox>
                                                    <cc1:AutoCompleteExtender ID="txtSuperUserId1_AutoCompleteExtender" runat="server" DelimiterCharacters="" Enabled="True" MinimumPrefixLength="1" ServiceMethod="Emp_Mas_Emp_Id" ServicePath="~/modules/Payroll/WebService.asmx" TargetControlID="txtSuperUserId1">
                                                    </cc1:AutoCompleteExtender>
                                                </td>
                                    ...
                                    <asp:GridView ID="grdViewForBindControl" runat="server"
                                        ...
                                        <Columns>
                                                ...
                                                <td colspan="13">
                                                    <asp:Panel ID="PanelForSearchControl" runat="server">
                                                        <table style="width: 100%;">
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="Label12" runat="server" Text="Section"></asp:Label>
                                                                </td>
                                                                <td>:</td>
                                                                <td>
                                                                    <asp:DropDownList ID="ddlSection" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlSection_SelectedIndexChanged" Width="300px">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td align="right">
                                                                    <asp:Label ID="Label13" runat="server" Text="Office Location"></asp:Label>
                                                                </td>
                                                                <td>:</td>
                                                                <td>
                                                                    <asp:DropDownList ID="ddlOfficeLocation" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlOfficeLocation_SelectedIndexChanged" Width="300px">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td>
                                                                    <asp:Button ID="btnSaveConfigurationbyDepartmentEmployee" runat="server" CssClass="btn2" OnClick="btnSaveConfigurationbyDepartmentEmployee_Click" OnClientClick="ShowConfirmBox(this,'Are you sure save data ?'); return false;" Text="Save" Width="100px" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </asp:Panel>
                                            ...
                                            <tr>
                                                <td colspan="13">
                                                    <asp:GridView ID="GridViewEmployeeDetails" runat="server" AutoGenerateColumns="False" EmptyDataText="No Data Found !" OnRowDataBound="GridViewEmployeeDetails_RowDataBound" OnSelectedIndexChanged="GridViewEmployeeDetails_SelectedIndexChanged" Width="1100px">
                                                        <Columns>
