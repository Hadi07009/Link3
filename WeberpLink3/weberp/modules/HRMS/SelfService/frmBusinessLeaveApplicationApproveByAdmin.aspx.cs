...
public partial class Modules_HRMS_SelfService_frmBusinessLeaveApplicationApproveByAdmin : System.Web.UI.Page
{
    ...
    private void LoadOvertimeDetailsemployeeID(string empid, string Processid, string flowid, DateTime fDate, DateTime lDate)
    {
        ...
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandText = "spProcessGetAttendanceStatus";
    ...
    protected void btnApply_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string retval = lvproc.ApplyAndApproveAttendanceProcessData(lvphdrlst, myCommand);
            if (retval.ToString() == "")
            {
                myTrans.Rollback("SaveAllTransaction");
            }
    ...
    private void SendMailtoApprover()
    {
        try
        {
            ...
            string msgbody = "I have applied a business leave for your approval.";
