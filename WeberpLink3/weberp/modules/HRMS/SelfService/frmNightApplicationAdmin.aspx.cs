...
public partial class ClientSide_modules_mis_naz_FORMS_HRMS_Forms_frmNightApplicationAdmin : System.Web.UI.Page
{
    ...
    protected void btnApply_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this, GetType(), "MessageBox", "alert(' Please configure night amount for this employee then apply');", true);
            return;
        }
