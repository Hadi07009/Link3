<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmNightApplicationAdmin.aspx.cs" Inherits="ClientSide_modules_mis_naz_FORMS_HRMS_Forms_frmNightApplicationAdmin" %>
                    ...
                    <ContentTemplate>
                        <div align="center">
                            <asp:Panel ID="PanelLeaveHdr" runat="server" CssClass="cpHeaderContent" Width="100%">
                                <asp:Label ID="lblleave" Text="NIGHT APPLICATION" runat="server" />
                            </asp:Panel>
                                            ...
                                            <asp:GridView ID="grdHoliday" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Out Date">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtntDate1" runat="server" Text='<%# Eval("ActualOutdate", "{0:d}") %>'> &gt;</asp:TextBox>
                                                    ...
                                                    <asp:BoundField DataField="ActualOutdate" HeaderText="ActualOutDate" />
                            ...
                            <%--<cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender2" runat="server"
                                ...
                                CollapsedText="NIGHT APPLICATION"
                                ExpandedText="NIGHT APPLICATION"
                                CollapsedSize="2"
                                ExpandedSize="1260"
                                AutoCollapse="False"
                                AutoExpand="False"
