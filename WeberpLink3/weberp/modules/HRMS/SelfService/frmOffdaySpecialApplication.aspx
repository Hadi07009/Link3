<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmOffdaySpecialApplication.aspx.cs" Inherits="ClientSide_modules_mis_naz_FORMS_HRMS_Forms_frmOffdaySpecialApplication" %>
                                            ...
                                            <asp:GridView ID="grdHoliday" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Days">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtNoOfDays" runat="server" Text='<%# Eval("noofdays") %>' Style="text-align: center" Width="50px"></asp:TextBox>
                                                        </ItemTemplate>
