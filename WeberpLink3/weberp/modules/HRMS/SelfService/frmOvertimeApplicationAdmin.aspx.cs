...
public partial class ClientSide_modules_mis_naz_FORMS_HRMS_Forms_frmOvertimeApplicationAdmin : System.Web.UI.Page
{
    ...
    protected void btnApply_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this, GetType(), "MessageBox", "alert('Please configure over time amount for this employee then apply');", true);
            return;
        }
    ...
    protected void btnTotal_Click(object sender, EventArgs e)
    {
        ...
        for (i = 0; i < rowNo; i++)
        {
            ...
            else if (chkbox.Checked == true && action == 0)
            {
                ...
                DateTime startDateForSpecial = new DateTime(2014, 6, 30);
                DateTime endDateForSpecial = new DateTime(2014, 7, 29);
