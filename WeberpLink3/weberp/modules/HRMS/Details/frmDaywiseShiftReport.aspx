                            ...
                            <asp:GridView ID="grdLeaveDetails" runat="server" Width="100%" AutoGenerateColumns="False">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Employee Code">
                                        <ItemTemplate>
                                            <asp:Label ID="lblLeave_Det_Emp_Id" runat="server" Text='<%# Bind("Atnd_Det_Emp_Id") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Date">
                                        <ItemTemplate>
                                            <asp:Label ID="lblLeave_Det_Sta_Date" runat="server" Text='<%# Bind("Atnd_det_date", "{0:d}") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="status">
                                        <ItemTemplate>
                                            <asp:Label ID="lblatendanceStatus" runat="server" Text='<%# Bind("atendanceStatus") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
