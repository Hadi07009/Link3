<%@ Page Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmResignationReport.aspx.cs" Inherits="modules_HRMS_Details_frmResignationReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="PanelLeaveHdr" runat="server" CssClass="cpHeaderContent" Width="100%">
        <asp:Label ID="lblleave" Text="Resignation Report" runat="server" />
    </asp:Panel>
    <asp:Panel ID="PanelLeaveDet" runat="server" CssClass="cpBodyContent" Width="100%" Height="100%">
        <table style="width: 99%; text-align: left">
            ...
            <tr>
                ...
                <td>&nbsp;</td>
                <td>
                    <asp:Button ID="btnResignation" runat="server" CssClass="btn2" OnClick="btnResignation_Click" Text="Resignation Information" Width="183px" />
                    <asp:Button ID="btnExportJoinResign" runat="server" CssClass="btn2" OnClick="btnExportJoinResign_Click" Text="Export" Width="183px" />
                    <asp:Button ID="btnResignationReport" runat="server" CssClass="btn2" OnClick="btnResignationReport_Click" Text="Resignation Report" Width="183px" />
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
