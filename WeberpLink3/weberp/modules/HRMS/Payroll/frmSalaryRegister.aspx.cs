...
public partial class modules_HRMS_Payroll_frmSalaryRegister : System.Web.UI.Page
{
    ...
    protected void btndeptsal_Click(object sender, EventArgs e)
    {
        ...
        string reportname = "../Reports/hrmsdeptsal.rpt";
    ...
    protected void btnSalreportPosted_Click(object sender, EventArgs e)
    {
        ...
        salmonth = strMonthName + "/" + txtSalaryDate.Text.Split('/')[1].ToString();
        DataProcess.ExecuteQuery(Session[GlobalData.sessionConnectionstring].ToString(), "if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[salarypostedview]') and OBJECTPROPERTY(id, N'IsView') = 1) drop view [dbo].[salarypostedview]");
        DataProcess.ExecuteQuery(Session[GlobalData.sessionConnectionstring].ToString(), "Create view salarypostedview as select * from Hrms_salary where month(salmonth)=" + mth + " and year(salmonth)=" + yr + " and Salgrade<>'50'");
        ...
        salmonth = "salmonth" + ":" + salmonth;
        parameter = salmonth + ";" + CompanyName + ";" + CompanyAddress;
        string reportname = "../Reports/HrmsEmpSal.rpt";
        ShowReport(selectionfor, parameter, reportname);
        }
        else if (rblForCondition.SelectedValue == "H")
        {
            ...
            DataProcess.ExecuteQuery(Session[GlobalData.sessionConnectionstring].ToString(), "if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[salarySaveModeview]') and OBJECTPROPERTY(id, N'IsView') = 1) drop view [dbo].[salarySaveModeview]");
            DataProcess.ExecuteQuery(Session[GlobalData.sessionConnectionstring].ToString(), "Create view salarySaveModeview as select * from Hrms_salary1 where month(salmonth)=" + mth + " and year(salmonth)=" + yr + " and Salgrade<>'50'");
            ...
            salmonth = "salmonth" + ":" + salmonth;
            parameter = salmonth + ";" + CompanyName + ";" + CompanyAddress;
            string reportname = "../Reports/HrmsEmpSal1.rpt";
            ShowReport(selectionfor, parameter, reportname);
        }
    }
    ...
    protected void btnDisbursementLetter_Click(object sender, EventArgs e)
    {
        if (ddlcompany.Text == "")
        {
            lblmsg.Text = "Company Selection Error";
        ...
        if (rblForCondition.SelectedValue == "P")
        {
            ...
            salmonth = "salmonth" + ":" + salmonth;
            parameter = salmonth + ";" + CompanyName + ";" + CompanyAddress;
            string reportname = "../Reports/HrmsDisburseLetter.rpt";
            ShowReport(selectionfor, parameter, reportname);
        }
        else if (rblForCondition.SelectedValue == "H")
        {
            lblmsg.Text = "Please select post option to get disbursement letter";
            lblmsg.Visible = true;
            return;
        }
    }
