<%@ Page Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmOtherAllowances.aspx.cs" Inherits="modules_HRMS_Payroll_frmOtherAllowances" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel ID="updpnl2" runat="server">
                ...
                <asp:Label ID="lblleave" Text="ALLOWANCES " runat="server" />
            </asp:Panel>
            <asp:Panel ID="PanelLeaveDet" runat="server" CssClass="cpBodyContent" Width="100%" Height="100%">
                <table style="width: 99%; text-align: left">
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>
                            <asp:Button ID="btnUploadAttachment" runat="server" OnClick="btnUploadAttachment_Click" OnClientClick="ShowConfirmBox(this,'Are you Sure, Upload Other Allowance?'); return false;" Text="Upload Allowance Document" Width="200px" />
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 168px">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>
                            <asp:Button ID="btnUploadTaxChallan" runat="server" OnClick="btnUploadTaxChallan_Click" OnClientClick="ShowConfirmBox(this,'Are you Sure, update Other Allowances Data?'); return false;" Text="Save &amp; Update Allowances" Width="200px" />
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 168px">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Allowance">
                                     ...
                                     <asp:TemplateField HeaderText="Allowance Type">
                                        <ItemTemplate>
                                            <asp:Label ID="lblType" runat="server" Text='<%# Bind("PayType") %>' ></asp:Label>
                                        </ItemTemplate>
                                         <HeaderStyle HorizontalAlign="Center" />
                                         <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
