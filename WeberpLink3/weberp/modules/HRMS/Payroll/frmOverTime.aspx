<%@ Page Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmOverTime.aspx.cs" Inherits="modules_HRMS_Payroll_frmOverTime" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel ID="updpnl2" runat="server">
                ...
                <asp:Label ID="lblleave" Text="Over Time Payment" runat="server" />
            </asp:Panel>
            <asp:Panel ID="PanelLeaveDet" runat="server" CssClass="cpBodyContent" Width="100%" Height="100%">
                <table style="width: 99%; text-align: left">
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>
                            <asp:Button ID="btnUploadAttachment" runat="server" OnClick="btnUploadAttachment_Click" OnClientClick="ShowConfirmBox(this,'Are you Sure, Upload Over time?'); return false;" Text="Upload Attachment" Width="150px" />
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 168px">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>
                            <asp:Button ID="btnUploadTaxChallan" runat="server" OnClick="btnUploadTaxChallan_Click" OnClientClick="ShowConfirmBox(this,'Are you Sure, update Over Time Data?'); return false;" Text="Update OT Amount" Width="150px" />
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 168px">
