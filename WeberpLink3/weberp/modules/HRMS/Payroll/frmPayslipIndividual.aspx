<%@ Page Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmPayslipIndividual.aspx.cs" Inherits="modules_HRMS_Payroll_frmPayslipIndividual" %>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <table id="tbldet" runat="server" style="width: 100%;">
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtEmpId" runat="server" autocomplete="off" AutoPostBack="True" CssClass="btn2" Visible="False" Width="380px"></asp:TextBox>
