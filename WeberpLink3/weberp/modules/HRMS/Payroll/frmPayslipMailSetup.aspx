<%@ Page Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmPayslipMailSetup.aspx.cs" Inherits="modules_HRMS_Payroll_frmPayslipMailSetup" %>
    ...
    <asp:UpdatePanel ID="updpnl2" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="PanelLeaveHdr" runat="server" CssClass="cpHeaderContent" Width="100%">
                <asp:Label ID="lblleave" Text="PAYSLIP MAIL SET" runat="server" />
            </asp:Panel>
            <asp:Panel ID="PanelLeaveDet" runat="server" CssClass="cpBodyContent" Width="100%" Height="100%">
                <table style="width: 100%; text-align: left">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <asp:TextBox ID="txtEmpId" runat="server" autocomplete="off" AutoPostBack="True" CssClass="btn2" Width="250px"></asp:TextBox>
                            <ajaxToolkit:AutoCompleteExtender ID="txtEmpId_AutoCompleteExtender" 
                                runat="server" BehaviorID="txtEmpId_AutoCompleteExtender" 
                            ...
                            &nbsp;<asp:Label ID="lblmsgPf0" runat="server" ForeColor="#CC0000">** Select Eemployee for individual mail set or Keep blank for all</asp:Label>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2">
                            <table id="tbldet" runat="server" style="width: 100%;">
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnSalreportPosted" runat="server" CssClass="btn2" OnClick="btnSalreportPosted_Click" Text="Pay Slip Mail Set" Width="300px" />
                                    </td>
                                    <td>&nbsp;</td>
                                    <td></td>
                                    <td>&nbsp;</td>
