<%@ Page Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frm_payroll_Cyclic.aspx.cs" Inherits="modules_HRMS_Payroll_frm_payroll_Cyclic" %>
    ...
    <asp:UpdatePanel ID="updpnl2" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="PanelLeaveHdr" runat="server" CssClass="cpHeaderContent" Width="100%">
                <asp:Label ID="lblleave" Text="PAYROLL CALCULATION (CYCLIC)" runat="server" />
            </asp:Panel>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <table id="tbldet" runat="server" style="width: 100%;">
                                        ...
                                        <table style="width:50%; text-align: left" >
                                            <tr>
                                                <td style="width: 152px" >
                                                    <asp:Label ID="Label3" runat="server" Text="Last Salary Month"></asp:Label>
                                                </td>
                                            ...
                                            <tr>
                                                <td style="width:152px">
                                                    <asp:Label ID="Label4" runat="server" Text="Current Salary Month"></asp:Label>
                                                </td>
                                                <td style="width: 8px">:</td>
                                                <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnCreatePayroll" runat="server" CssClass="btn2" OnClick="btnCreatePayroll_Click" OnClientClick="ShowConfirmBox(this,'Are you sure create payroll ?'); return false;" Text="Payroll Calculate" Width="360px" />
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnpost" runat="server" CssClass="btn2" ForeColor="Red" OnClick="btnpost_Click" OnClientClick="ShowConfirmBox(this,'Are you sure post payroll ?'); return false;" Text="Payroll Post" Width="360px" />
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
