...
public partial class modules_HRMS_Approval_frmExpensesBillApplicationApproval : Page 
{
    ...
    private void LoadAdvanceReceivedData(string transactionNo)
    {
        try
        {
            ProcessAdvancePayment objProcessAdvancePayment = new ProcessAdvancePayment();
            objProcessAdvancePayment.TransactionNo = transactionNo;
            ExpensesClaimController objExpensesClaimController = new ExpensesClaimController();
            var dtAdvanceReceived = objExpensesClaimController.GetAdvanceReceivedAmount(_connectionString, objProcessAdvancePayment);
