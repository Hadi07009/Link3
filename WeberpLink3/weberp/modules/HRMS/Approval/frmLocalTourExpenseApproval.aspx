<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmLocalTourExpenseApproval.aspx.cs" Inherits="modules_HRMS_Approval_frmLocalTourExpenseApproval" %>
        ...
        <ContentTemplate>
            <div align="center">
                <asp:Panel ID="pnlSrchHdr" runat="server" CssClass="cpHeaderContent" Width="100%">
                    PENDING LOCAL TOUR EXPENSE APPROVAL
                </asp:Panel>
            ...
            <asp:Panel ID="PanelForDetails" runat="server" Width="100%">
                <div align="center">
                    <asp:Panel ID="PanelLeaveHdr" runat="server" CssClass="cpHeaderContent" Width="100%">
                        <asp:Label ID="lblleave" Text="LOCAL TOUR EXPENSE DETAILS" runat="server" />
                    </asp:Panel>
                    <asp:Panel ID="PanelLeaveDet" runat="server" CssClass="cpBodyContent" Height="100%">
                        <table style="width: 99%; text-align: left">
                            ...
                            <tr align="left">
                                ...
                                <tr>
                                    <td style="width: 115px">
                                        <asp:Label ID="Label18" runat="server" Text="Place of Visit :"></asp:Label>
                                    </td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td class="auto-style12">
                                        <asp:Label ID="lblFrom" runat="server" Width="150px"></asp:Label>
                                    </td>
                                    <td style="width: 39px">&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td class="auto-style12">
                                        <asp:Label ID="lblTo" runat="server" Width="150px"></asp:Label>
                                    </td>
                                    <td style="width: 39px">&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                    ...
                    <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender2" runat="server"
                        ...
                        CollapsedText="LOCAL TOUR EXPENSE DETAILS"
                        ExpandedText="LOCAL TOUR EXPENSE DETAILS"
                        AutoCollapse="False"
                        AutoExpand="false"
                        ScrollContents="false"
                        ImageControlID="Image1"
