<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmLunchBillApplicationApproval.aspx.cs" Inherits="modules_HRMS_Approval_frmLunchBillApplicationApproval" %>
            ...
            <div align="center">
                ...
                <asp:Panel ID="pnlSrchDet" runat="server" CssClass="cpBodyContent" Height="100%">
                    <table style="width: 99%; text-align: left">
                        ...
                        <tr>
                            <td colspan="3">
                                <asp:GridView ID="grdPendingLunchBill" runat="server" Width="100%" AutoGenerateColumns="False" OnRowCommand="grdPendingLunchBill_RowCommand" OnRowDataBound="grdPendingLunchBill_RowDataBound" OnSelectedIndexChanged="grdPendingLunchBill_SelectedIndexChanged">
                                    <Columns>
            ...
            <asp:Panel ID="PanelForDetails" runat="server" Width="100%">
                <div align="center">
                    <asp:Panel ID="PanelLeaveHdr" runat="server" CssClass="cpHeaderContent" Width="100%">
                        <asp:Label ID="lblleave" Text="LUNCH BILL DETAILS" runat="server" />
                    </asp:Panel>
                            ...
                            <tr>
                                <td colspan="3">
                                    <asp:GridView ID="grdLunchBillDetails" runat="server"
                                        Width="100%" AutoGenerateColumns="False" OnRowDataBound="grdLunchBillDetails_RowDataBound">
                                        <Columns>
                    ...
                    <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender2" runat="server"
                        ...
                        CollapsedText="LUNCH BILL DETAILS"
                        ExpandedText="LUNCH BILL DETAILS"
                        AutoCollapse="False"
                        AutoExpand="false"
                        ScrollContents="false"
                        ImageControlID="Image1"
