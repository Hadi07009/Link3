<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmAttendanceApplicationApproval.aspx.cs" Inherits="modules_HRMS_Approval_frmAttendanceApplicationApproval" %>
         ...
         <ContentTemplate>
             <div align="center">
                 ...
                 <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtenderSrch" runat="server"
                                ...
                                CollapsedText="Pending Attendance Application"
                                ExpandedText="Pending Attendance Application"
                                AutoCollapse="False"
                                AutoExpand="false"
