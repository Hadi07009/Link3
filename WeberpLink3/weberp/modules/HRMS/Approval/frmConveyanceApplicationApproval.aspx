<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmConveyanceApplicationApproval.aspx.cs" Inherits="modules_HRMS_Approval_frmConveyanceApplicationApproval" %>
            ...
            <div align="center">
                ...
                <asp:Panel ID="pnlSrchDet" runat="server" CssClass="cpBodyContent" Height="100%">
                    <table style="width: 99%; text-align: left">
                        ...
                        <tr>
                            <td colspan="3">
                                <asp:GridView ID="grdPendingConveyance" runat="server" Width="100%" AutoGenerateColumns="False" OnRowCommand="grdPendingConveyance_RowCommand" OnRowDataBound="grdPendingConveyance_RowDataBound" OnSelectedIndexChanged="grdPendingConveyance_SelectedIndexChanged">
                                    <Columns>
            ...
            <asp:Panel ID="Panel50" runat="server" Width="100%">
                <div align="center">
                    <asp:Panel ID="PanelLeaveHdr" runat="server" CssClass="cpHeaderContent" Width="100%">
                        <asp:Label ID="lblleave" Text="CONVEYANCE APPLICATION DETAILS" runat="server" />
                    </asp:Panel>
                    <asp:Panel ID="PanelLeaveDet" runat="server" CssClass="cpBodyContent" Height="100%">
                        <table style="width: 99%; text-align: left">
                            ...
                            <tr>
                                <td colspan="3">
                                    <asp:GridView ID="grdConveyanceDetails" runat="server"
                                        Width="100%" AutoGenerateColumns="False" OnRowDataBound="grdConveyanceDetails_RowDataBound">
                                        <Columns>
                                        ...
                                        <ItemStyle HorizontalAlign="Center" />
                                            ...
                                            <asp:TemplateField HeaderText="Purpose of Journey">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblpurposeofJourney" runat="server" Text='<%# Bind("purposeofJourney") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Mode of Journey">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblmodeofJourney" runat="server" Text='<%# Bind("modeofJourney") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                    ...
                    <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender2" runat="server"
                        ...
                        CollapsedText="CONVEYANCE APPLICATION DETAILS"
                        ExpandedText="CONVEYANCE APPLICATION DETAILS"
                        AutoCollapse="False"
                        AutoExpand="false"
                        ScrollContents="false"
                        ImageControlID="Image1"
