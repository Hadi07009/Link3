<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmEarnLeaveApplicationApproval.aspx.cs" Inherits="modules_HRMS_Approval_frmEarnLeaveApplicationApproval" %>
        ...
        <ContentTemplate>
            <div align="center">
                            ...
                            <td colspan="3">
                                            <asp:GridView ID="GridViewLeavePending" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="elench" HeaderStyle-HorizontalAlign="Left"
                                                    ...
                                                    <asp:BoundField DataField="elamt" HeaderStyle-HorizontalAlign="Center"
                                                        HeaderText="Amount" ItemStyle-HorizontalAlign="Center">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:Button ID="btnSubmit" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                                                CommandName="Submit" runat="server" Text="Submit" Width="100px" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:Button ID="btnprint" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                                                CommandName="Preview" runat="server" Text="Preview" Width="100px" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                ...
                <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtenderSrch" runat="server"
                                ...
                                CollapsedText="Pending Earned Leave Application"
                                ExpandedText="Pending Earned Leave Application"                                
                                AutoCollapse="False"
                                AutoExpand="false"
            ...
            <asp:Panel ID="Panel50" runat="server" Width="100%">
                <div align="center">
                    <asp:Panel ID="PanelLeaveHdr" runat="server" CssClass="cpHeaderContent" Width="100%">
                        <asp:Label ID="lblleave" Text="EARNED LEAVE ENCASH DETAILS" runat="server" />
                    </asp:Panel>
