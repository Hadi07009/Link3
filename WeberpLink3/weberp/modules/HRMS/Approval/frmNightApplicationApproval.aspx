<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmNightApplicationApproval.aspx.cs" Inherits="modules_HRMS_Approval_frmNightApplicationApproval" %>
        ...
        <ContentTemplate>
            <div align="center">
                            ...
                            <td colspan="3">
                                <asp:GridView ID="GridViewLeavePending" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Night" HeaderStyle-HorizontalAlign="Left"
                                                        HeaderText="Night" ItemStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:BoundField>
                ...
                <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtenderSrch" runat="server"
                                ...
                                CollapsedText="Pending Night Application"
                                ExpandedText="Pending Night Application"                                
                                AutoCollapse="False"
                                AutoExpand="false"
            ...
            <asp:Panel ID="Panel50" runat="server" Width="100%">
                <div align="center">
                    <asp:Panel ID="PanelLeaveHdr" runat="server" CssClass="cpHeaderContent" Width="100%">
                        <asp:Label ID="lblleave" Text="NIGHT APPLICATION DETAILS" runat="server" />
                    </asp:Panel>
                                    ...
                                    <table style="width: 100%;">
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center">
                                                            <asp:Label ID="Label15" runat="server" Text="Previous Night Information"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="style9">
                                                        ...
                                                        <td style="text-align: right">
                                                            <table style="width: 100%;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="style22">&nbsp;</td>
                                                                    <td>
                                                                        <asp:Button ID="btnShow" runat="server" Text="Show Night" Width="100px"
