<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frm_movement_monitoring_fob.aspx.cs" Inherits="frm_movement_monitoring_fob" EnableEventValidation="false" ValidateRequest="false"  %>
                                ...
                                <td colspan="3">
                                    <table style="width:100%;">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:RadioButtonList ID="chkmotype" runat="server" RepeatDirection="Horizontal">
                                                    ...
                                                    <tr>
                                                        <td rowspan="3">
                                                            <asp:RadioButtonList ID="rdocat" runat="server" Width="139px" AutoPostBack="True" OnSelectedIndexChanged="rdocat_SelectedIndexChanged">
                                                                ...
                                                                <asp:ListItem Value="3">MOV Ref</asp:ListItem>
                                                        ...
                                                        <td>
                                                            <table id="tbl_movement" runat="server" style="width:100%;">
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 89px; text-align: right;">Mov Ref:</td>
                                                                    <td>
