<%@ Page Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frm_quo_approval.aspx.cs" Inherits="frm_quo_approval" Title=""   ValidateRequest="false" EnableViewState="true"  %>
...
.tbl
{
        ...
        <td colspan="3" class="tbl">
                ...
                <table id="tbl_product" width="100%" runat="server"  style="border-top-width: 1px; border-left-width: 1px; border-left-color: #e6e6fa; filter: progid:dximagetransform.microsoft.gradient(endcolorstr='white', startcolorstr='#D6DCF9', gradienttype='0'); border-bottom-width: 1px; border-bottom-color: #e6e6fa; border-top-color: #e6e6fa; border-right-width: 1px; border-right-color: #e6e6fa;">
                    ...
                    <tr>
                        ...
                        &nbsp;<input id="btnview_po" class="btn2" onclick="javascript:getpo();" type="button" value="View PO Detail" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td id="Td3" runat="server" colspan="3" style="text-align: center">
                            Comments: 
                    ...
                    <tr>
                        <td id="Td5" runat="server" class="style34" colspan="3" 
    ...
    <tr>
     ...
     <script type="text/javascript" language="javascript">
         function getpo() {
             var hdnfld = document.getElementById("<%= ddlrecentlist.ClientID %>").value;
            if (hdnfld != "")
                window.open('./frm_po_lifecycle.aspx?ref_no=' + hdnfld);
        }
</script>
</asp:Content>
