<%@ Page Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frm_app_det.aspx.cs" Inherits="frm_app_det" Title=""   EnableEventValidation="false" %>
                ...
                <table style="width: 84%;">
                    ...
                    <tr>
                        ...
                        <td style="width: 16px">
                            :</td>
                        <td style="width: 307px; text-align: left">
                            <asp:TextBox ID="txttype" runat="server" CssClass="txtbox"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left; width: 102px">
