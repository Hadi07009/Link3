<%@ Page Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frm_tender_inquiry_view.aspx.cs" Inherits="frm_tender_inquiry_view" Title=""  EnableEventValidation="false" ValidateRequest ="false"   %>
...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            <td style="height: 27px">
                                <asp:Button ID="btnagain" runat="server" CssClass="btn2" 
                                    onclick="btnagain_Click" Text="TRY AGAIN" Width="95px" />
