...
public partial class frm_mpr_pending_det : System.Web.UI.Page
{
    ...
    protected void GdHeader_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            decimal mrrqty = Convert.ToDecimal(e.Row.Cells[9].Text);
            if (mrrqty == 0) { e.Row.Attributes.Add("style", "background-color:#FFCCFF"); }
            else if (mrrqty < mprqty) { e.Row.Attributes.Add("style", "background-color:#FFFF99"); }
