<%@ Page Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frm_po_status_hdr.aspx.cs" Inherits="frm_po_status_hdr" Title=""    %>
...
<table id="tblmaster" runat="server" class="tblmas" style="width: 100%">
        ...
        <tr>
            <td class="heading" style="text-align: center">
                PURCHASE ORDER STATUS DETAIL&nbsp;</td>
        </tr>
        <tr>
                 ...
                 <asp:GridView ID="gdItem" runat="server"  Width="100%"
                  ...
                  <Columns>
                        <asp:TemplateField HeaderText="MRR Detail">
                            <ItemTemplate>
                                <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#41519A" BorderStyle="Solid" BorderWidth="1px" 
                    CellPadding="4" ForeColor="#333333" GridLines="None" 
                    PageSize="100" SkinID="GridView" />
                            </ItemTemplate>
                        </asp:TemplateField>
