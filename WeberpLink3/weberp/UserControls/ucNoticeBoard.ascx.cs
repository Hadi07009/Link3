...
public partial class usercontrols_ucNoticeBoard : System.Web.UI.UserControl
{
    ...
    private void LoadUploadFileByRef()
    {
        ...
        dt = DataProcess.GetData(_connectionString, "select 1 as SL, documentCode as [ReferenceNo],documentContent as [FileName],documentName as [SavedFileName]  from HRMS_Document where documentTypeCode=2 and status=1 order by [ReferenceNo]");
